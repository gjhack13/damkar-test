...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				user.email LIKE ? OR 
				user.jabatan LIKE ? OR 
				user.unit_kerja LIKE ? OR 
				user.nomor_hp LIKE ? OR 
				user.photo LIKE ? OR 
				user.role LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama","username","password","email","jabatan","unit_kerja","nomor_hp","photo","role","user_role_id");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","nama","username","jabatan","unit_kerja","nomor_hp","photo");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
