                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="unit_kerja">Unit Kerja <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-unit_kerja"  value="<?php  echo $this->set_field_value('unit_kerja',""); ?>" type="text" placeholder="Enter Unit Kerja"  required="" name="unit_kerja"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="nomor_hp">Nomor Hp <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-nomor_hp"  value="<?php  echo $this->set_field_value('nomor_hp',""); ?>" type="text" placeholder="Enter Nomor Hp"  required="" name="nomor_hp"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-user_role_id" name="user_role_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php
                                                                                    $user_role_id_options = Menu :: $user_role_id2;
