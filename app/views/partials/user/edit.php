                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-unit_kerja"  value="<?php  echo $data['unit_kerja']; ?>" type="text" placeholder="Enter Unit Kerja"  required="" name="unit_kerja"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-nomor_hp"  value="<?php  echo $data['nomor_hp']; ?>" type="text" placeholder="Enter Nomor Hp"  required="" name="nomor_hp"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
