                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-unit_kerja"> Unit Kerja</th>
                                                <th  class="td-nomor_hp"> Nomor Hp</th>
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-unit_kerja">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['unit_kerja']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="unit_kerja" 
                                                            data-title="Enter Unit Kerja" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-nomor_hp">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nomor_hp']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="nomor_hp" 
                                                            data-title="Enter Nomor Hp" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
