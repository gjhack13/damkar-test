...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'contact_us' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'profile_rupat_1' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'profile_rupat_2' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'profile_rupat_3' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'profile_rupat_dp' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'ruang_dewan_pengarah' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'ruang_rapat' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'absensi' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'ruang_rapat_lantai_2' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'ruang_rapat_lantai_3' => array('list','view','add','edit', 'editfield','delete','import_data'),
			...
			'user' =>
						array(
							'contact_us' => array('list','view'),
							'profile_rupat_1' => array('list','view'),
							'profile_rupat_2' => array('list','view'),
							'profile_rupat_3' => array('list','view'),
							'profile_rupat_dp' => array('list','view'),
							'ruang_dewan_pengarah' => array('list','view','add','import_data'),
							'ruang_rapat' => array('list','view','add','import_data'),
							'absensi' => array('list','view','add','import_data'),
							'ruang_rapat_lantai_2' => array('list','view','add','import_data'),
							'ruang_rapat_lantai_3' => array('list','view','add','import_data')
						)
		);
